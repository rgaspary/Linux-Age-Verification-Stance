...
| **Garuda Linux** | ❌ Non-Compliant | Developers stated the distribution will not introduce age verification measures, citing the absence of legal requirements in its jurisdictions. | [TechRadar](https://www.techradar.com/pro/one-penguin-that-isnt-suitable-for-kids-linux-will-now-carry-out-age-verification-checks) |
